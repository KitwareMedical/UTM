...
if [ "$#" -lt 8 ]; then
    echo "Usage $0 Images-Folder Variables-Table n-Permutations threshold massCost transportType Analysis-Path analysisOnlyFlag slice-axial slice-coronal slice-sagital"
    return 1
fi
IMAGES_PATH=$1
VAR_TABLE=$2
...
BARYCENTER_OT_DISCRETE_FILE="$BARYCENTER_FOLDER/barycenter-euclidean.Rdata"
