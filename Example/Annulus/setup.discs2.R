...
for(i in 1:n){
  ...
  # Set the outer radius of the outer annulus and the outer radius of the inner annulus
  r1 = 1.95
  r2 = 1

  # Set the thicknesses of the annuli
  d1 = 0.3
  d2 = 0.3
  ...
  # So the defintion of the variable "mass" here is a little weird.
